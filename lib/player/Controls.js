...
class PlayerControls {
  ...
  IsPlaying() {
    if (this.player.casting) {
      return this.player.castHandler.IsPlaying();
    }
  ...
  async Play() {
    if (this.player.casting) {
      return this.player.castHandler.Play();
    }
  ...
  Pause() {
    if (this.player.casting) {
      return this.player.castHandler.Pause();
    }
  ...
  TogglePlay() {
    if (this.player.casting) {
      return this.player.castHandler.TogglePlay();
    }
  ...
  Stop() {
    if (this.player.casting) {
      return this.player.castHandler.Stop();
    }
  ...
  GetCurrentTime() {
    if (this.player.casting) {
      return this.player.castHandler.GetCurrentTime();
    }
  ...
  GetDuration() {
    if (this.player.casting) {
      return this.player.castHandler.GetDuration();
    }
  ...
  Seek({ fraction, time, relativeSeconds }) {
    if (this.player.casting) {
      return this.player.castHandler.Seek({ fraction, time, relativeSeconds });
    }
  ...
  GetVolume() {
    if (this.player.casting) {
      return this.player.castHandler.GetVolume();
    }
  ...
  SetVolume({ fraction, relativeFraction }) {
    if (this.player.casting) {
      return this.player.castHandler.SetVolume({ fraction, relativeFraction });
    }
  ...
  IsMuted() {
    if (this.player.casting) {
      return this.player.castHandler.IsMuted();
    }
  ...
  Mute() {
    if (this.player.casting) {
      return this.player.castHandler.Mute();
    }
  ...
  Unmute() {
    if (this.player.casting) {
      return this.player.castHandler.Unmute();
    }
  ...
  ToggleMuted() {
    if (this.player.casting) {
      return this.player.castHandler.ToggleMuted();
    }
  ...
  GetPlaybackRate() {
    if (this.player.casting) {
      return this.player.castHandler.GetPlaybackRate();
    }
  ...
  GetPlaybackRates() {
    ...
    options = options.map((speed, index) => ({
      index,
  ...
  SetPlaybackRate({ index, rate }) {
    if (this.player.casting) {
      return this.player.castHandler.SetPlaybackRate({ index, rate });
    }
  ...
  IsDVRAvailable() {
    return (
      this.player.dvrAvailable &&
      !this.player.casting &&
      isFinite(this.GetDuration())
    );
  }
  ...
  GetDebugInfo() {
    ...
    let error =
      this.player.__error && JSON.parse(JSON.stringify(this.player.__error));
