...
export const DefaultParameters = {
  ...
  playerOptions: {
    ...
    markInOut: false,
    markInOutCallback: undefined,
    previewMode: false,
    onShare: undefined,
    // shareConfig: { baseUrl, embedSrc?, title?, templates? }
    // When set, the share button opens an in-player popup with channel
    // buttons, copyable URL (UTM tagged), and a "Start at" toggle.
    // If both shareConfig and onShare are set, shareConfig wins.
